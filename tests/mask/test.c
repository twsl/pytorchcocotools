...
int main()
{
    ...
    RLE *rleArray = (RLE *)malloc(2 * sizeof(RLE));
    RLE *rle1 = (RLE *)malloc(sizeof(RLE));
    RLE *rle2 = (RLE *)malloc(sizeof(RLE));

    char *s1 = "\\`_3;j<6M3E_OjCd0T<:O1O2O001O00001O00001O001O0000O1K6J5J6A^C0g<N=O001O0O2Omk^4";
    char *s2 = "RT_32n<<O100O0010O000010O0001O00001O000O101O0ISPc4";

    rleFrString(rle1, s1, h, w);
    rleFrString(rle2, s2, h, w);

    int n = 1;
    byte *mask = (byte *)malloc(h * w * n * sizeof(byte));
    rleDecode(rle1, mask, n);
    ...
    RLE *rle_result = (RLE *)malloc(sizeof(RLE));
    rleMerge(rleArray, rle_result, 2, 0);

    char *s = rleToString(rle_result);
